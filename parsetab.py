...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','teste.py',45),
  ('expr -> expr MINUS expr','expr',3,'p_sub','teste.py',49),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','teste.py',53),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','teste.py',57),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','teste.py',58),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','teste.py',69),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','teste.py',73),
]
